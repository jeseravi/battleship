    ...
    Array.from(document.getElementsByClassName("boardButton unselectedBoardButton")).forEach(item => {
        item.addEventListener('click', event =>{
            ...
            for(let i=0;i<nameOfShip.length;i++){
                ...
                //need a check to make sure that you can't place a ship on top of another ship

                //current bug having issues with breaking. Colors are being filled unexpectedly
...
function boardMaker(dimensions){
    ...
    for (let i=0;i<dimensions;i++){
        ...
        generateElement("button",i,"","boardContainer",xCoordinate+","+yCoordinate,"boardButton unselectedBoardButton")
